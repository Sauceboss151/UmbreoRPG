...
public class Modelnetherite_armor_layer_1<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("umbreo_rpg", "modelnetherite_armor_layer_1"),
			"main");
	...
	public Modelnetherite_armor_layer_1(ModelPart root) {

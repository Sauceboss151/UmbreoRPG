...
public class Modelultrium_armor_model<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("umbreo_rpg", "modelultrium_armor_model"),
			"main");
	...
	public Modelultrium_armor_model(ModelPart root) {

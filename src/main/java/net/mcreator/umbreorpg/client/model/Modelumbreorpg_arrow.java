...
public class Modelumbreorpg_arrow<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("umbreo_rpg", "modelumbreorpg_arrow"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Arrow = partdefinition.addOrReplaceChild("Arrow", CubeListBuilder.create(), PartPose.offset(0.0F, 22.0F, 0.0F));
		PartDefinition cube_r1 = Arrow.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 0).addBox(-0.5F, 1.5F, 0.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-1.5F, -0.5F, -13.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-0.5F, -0.5F, -14.0F, 1.0F,
								1.0F, 16.0F, new CubeDeformation(0.0F)),

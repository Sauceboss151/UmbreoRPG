package net.mcreator.umbreorpg.client.model;
...
public class Modelimpmodel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("umbreo_rpg", "modelimpmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(26, 0).addBox(-0.6F, -0.5F, -1.2F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.7367F, -2.3007F, 1.9429F, -0.3162F, 0.6885F, -0.1752F));
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(28, 27).addBox(-0.4815F, -0.7432F, -1.9682F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.8595F, -2.2674F, 1.0916F, -0.3486F, -0.711F, 0.2329F));
		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(12, 10).addBox(-0.4929F, -0.7612F, -0.0328F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 29).addBox(-0.6843F, -1.25F, -1.1689F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = Head.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Head.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 10).addBox(-0.5F, -0.9066F, -1.1088F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Head.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(0, 10).addBox(-2.0F, -4.0F, -2.25F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.0465F, -0.0035F, -0.2618F, 0.0F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -4.25F, -2.5F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(15, 0)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offset(-2.5F, 13.0F, 1.5F));
		PartDefinition cube_r8 = RightArm.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(28, 13).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 3.0F, 0.0F, 0.0F, 0.0F, 0.0698F));
		PartDefinition cube_r9 = RightArm.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(16, 20).addBox(-1.4698F, -0.829F, -1.25F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, 0.0F, 0.25F, 0.0F, 0.0F, 0.4363F));
		PartDefinition cube_r10 = RightArm.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(0, 18).addBox(-1.0F, -0.75F, -0.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 3.0F, -0.5F, -1.1345F, 0.0F, 0.0F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(11, 13).addBox(0.25F, -4.9302F, -0.1853F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.75F, 13.0F, 1.75F, -3.0107F, 0.0F, 0.0F));
		PartDefinition cube_r11 = LeftArm.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(16, 27).addBox(-0.7F, -1.0035F, -0.6F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = LeftArm.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(20, 11).addBox(-0.1217F, -3.3239F, -0.4741F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r13 = RightLeg.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(22, 24).addBox(-1.9F, -2.75F, -2.25F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = RightLeg.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(26, 9).addBox(-1.0F, -1.1768F, -0.4697F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = RightLeg.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(27, 3).addBox(-1.0F, -0.8085F, -1.1607F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = RightLeg.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(8, 20).addBox(-0.5F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = LeftLeg.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(24, 18).addBox(-1.9F, -2.75F, -2.25F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = LeftLeg.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(0, 25).addBox(-1.0F, -1.1768F, -0.4697F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = LeftLeg.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(8, 26).addBox(-1.0F, -0.8085F, -1.1607F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = LeftLeg.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(20, 5).addBox(-0.5F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),

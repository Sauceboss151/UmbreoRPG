...
public class SkillListAlchemyGUIScreen extends AbstractContainerScreen<SkillListAlchemyGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("umbreo_rpg:textures/skill_list_alchemy_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("umbreo_rpg:textures/alchemy_decore_texture.png"));

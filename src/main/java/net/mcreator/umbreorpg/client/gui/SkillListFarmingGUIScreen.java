...
public class SkillListFarmingGUIScreen extends AbstractContainerScreen<SkillListFarmingGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("umbreo_rpg:textures/skill_list_farming_gui.png");
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("umbreo_rpg:textures/farming_decor_texture.png"));

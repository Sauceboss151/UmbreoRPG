...
public class LathiumBowRenderer extends EntityRenderer<LathiumBowEntity> {
	...
	public LathiumBowRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelumbreorpg_arrow(context.bakeLayer(Modelumbreorpg_arrow.LAYER_LOCATION));
	}

	@Override
	public void render(LathiumBowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(LathiumBowEntity entity) {
		return texture;
	}
}

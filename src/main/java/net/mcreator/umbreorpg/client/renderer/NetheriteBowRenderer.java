...
public class NetheriteBowRenderer extends EntityRenderer<NetheriteBowEntity> {
	...
	public NetheriteBowRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelumbreorpg_arrow(context.bakeLayer(Modelumbreorpg_arrow.LAYER_LOCATION));
	}

	@Override
	public void render(NetheriteBowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(NetheriteBowEntity entity) {
		return texture;
	}
}

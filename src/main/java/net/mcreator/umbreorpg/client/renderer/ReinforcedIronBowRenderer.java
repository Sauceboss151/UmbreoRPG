...
public class ReinforcedIronBowRenderer extends EntityRenderer<ReinforcedIronBowEntity> {
	...
	public ReinforcedIronBowRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelumbreorpg_arrow(context.bakeLayer(Modelumbreorpg_arrow.LAYER_LOCATION));
	}

	@Override
	public void render(ReinforcedIronBowEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(ReinforcedIronBowEntity entity) {
		return texture;
	}
}

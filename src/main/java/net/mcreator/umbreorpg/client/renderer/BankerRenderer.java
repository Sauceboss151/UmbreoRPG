...
public class BankerRenderer extends HumanoidMobRenderer<BankerEntity, HumanoidModel<BankerEntity>> {
	...
	public ResourceLocation getTextureLocation(BankerEntity entity) {
		return new ResourceLocation("umbreo_rpg:textures/entities/banker.png");
	}
}

...
public class CookingRangeBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public CookingRangeBlockEntity(BlockPos position, BlockState state) {
		super(UmbreoRpgModBlockEntities.COOKING_RANGE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("cooking_range");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CookingRangeGUIMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

...
public class IronBowItem extends Item {
	public IronBowItem() {
		super(new Item.Properties().tab(UmbreoRpgModTabs.TAB_UMBREO_COMBAT).durability(433));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					IronBowEntity entityarrow = IronBowEntity.shoot(world, entity, world.getRandom(), 1f, 5.5, 2);

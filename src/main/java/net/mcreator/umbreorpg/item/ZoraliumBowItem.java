...
public class ZoraliumBowItem extends Item {
	public ZoraliumBowItem() {
		super(new Item.Properties().tab(UmbreoRpgModTabs.TAB_UMBREO_COMBAT).durability(533));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ZoraliumBowEntity entityarrow = ZoraliumBowEntity.shoot(world, entity, world.getRandom(), 1f, 7, 2);

...
public class SkoriumBowItem extends Item {
	public SkoriumBowItem() {
		super(new Item.Properties().tab(UmbreoRpgModTabs.TAB_UMBREO_COMBAT).durability(583));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					SkoriumBowEntity entityarrow = SkoriumBowEntity.shoot(world, entity, world.getRandom(), 1f, 8, 3);

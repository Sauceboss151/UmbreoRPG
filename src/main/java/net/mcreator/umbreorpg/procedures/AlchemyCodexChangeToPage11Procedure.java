...
public class AlchemyCodexChangeToPage11Procedure {
				...
				if (entity instanceof ServerPlayer _ent) {
					...
					NetworkHooks.openGui((ServerPlayer) _ent, new MenuProvider() {
						...
						public Component getDisplayName() {
							return new TextComponent("AlchemyCodexPage11");
						}

						@Override
						public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
							return new AlchemyCodexPage11Menu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
						}
					}, _bpos);
				}
			}

...
public class GatesOfFatesFirstSpawnInProcedure {
	@SubscribeEvent
			...
			new Object() {
				...
				private void run() {
					if ((entity.getCapability(UmbreoRpgModVariables.PLAYER_VARIABLES_CAPABILITY, null)
							.orElse(new UmbreoRpgModVariables.PlayerVariables())).umbreoRpgFateChosenTeleport == false) {
						if (entity instanceof ServerPlayer _player && !_player.level.isClientSide()) {
							ResourceKey<Level> destinationType = ResourceKey.create(Registry.DIMENSION_REGISTRY,
									new ResourceLocation("umbreo_rpg:world_of_fates"));

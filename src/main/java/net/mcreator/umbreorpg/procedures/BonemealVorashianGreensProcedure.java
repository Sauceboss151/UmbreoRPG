...
public class BonemealVorashianGreensProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity) {
		if (entity == null)
			return;
		double randomChance = 0;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL
				&& blockstate.getBlock() == UmbreoRpgModBlocks.VORASHIAN_GREENS_STAGE_4.get()) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL
				&& blockstate.getBlock() == UmbreoRpgModBlocks.VORASHIAN_GREENS_STAGE_3.get()) {
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.1), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.9), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.1), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.9), 0, 0, 0);
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL
				&& blockstate.getBlock() == UmbreoRpgModBlocks.VORASHIAN_GREENS_STAGE_2.get()) {
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.1), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.9), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.1), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.9), 0, 0, 0);
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL
				&& blockstate.getBlock() == UmbreoRpgModBlocks.VORASHIAN_GREENS_STAGE_1.get()) {
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.1), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.9), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.1), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.9), 0, 0, 0);
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BONE_MEAL
				&& blockstate.getBlock() == UmbreoRpgModBlocks.VORASHIAN_GREENS_STAGE_0.get()) {
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.1), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.9), (y + 0.5), (z + 0.5), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.1), 0, 0, 0);
			world.addParticle(ParticleTypes.COMPOSTER, (x + 0.5), (y + 0.5), (z + 0.9), 0, 0, 0);

...
public class SweetPotatoSeedsPlantProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == Blocks.FARMLAND
			...
			if ((entity.getCapability(UmbreoRpgModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				...
				world.setBlock(new BlockPos(x, y + 1, z), UmbreoRpgModBlocks.BOREAL_SWEET_POTATO_STAGE_0.get().defaultBlockState(), 3);
				(itemstack).shrink(1);
			} else {

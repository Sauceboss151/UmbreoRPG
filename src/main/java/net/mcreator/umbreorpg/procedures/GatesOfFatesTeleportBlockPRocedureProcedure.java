...
public class GatesOfFatesTeleportBlockPRocedureProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof Player _player && !_player.level.isClientSide())
			_player.displayClientMessage(new TextComponent("You Will Be Teleported In 3 Seconds"), (false));
		new Object() {
			private int ticks = 0;
			...
			private void run() {
				{
					...
					entity.getCapability(UmbreoRpgModVariables.PLAYER_VARIABLES_CAPABILITY, null).ifPresent(capability -> {
						capability.umbreoRpgFateChosenTeleport = _setval;

...
public class UmbreoRpgModItems {
	...
	public static final RegistryObject<Item> TWILIGHT_OAK_WOOD = block(UmbreoRpgModBlocks.TWILIGHT_OAK_WOOD, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> TWILIGHT_OAK_LOG = block(UmbreoRpgModBlocks.TWILIGHT_OAK_LOG, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> TWILIGHT_OAK_PLANKS = block(UmbreoRpgModBlocks.TWILIGHT_OAK_PLANKS, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> TWILIGHT_OAK_LEAVES = block(UmbreoRpgModBlocks.TWILIGHT_OAK_LEAVES, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> TWILIGHT_OAK_STAIRS = block(UmbreoRpgModBlocks.TWILIGHT_OAK_STAIRS, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> TWILIGHT_OAK_SLAB = block(UmbreoRpgModBlocks.TWILIGHT_OAK_SLAB, CreativeModeTab.TAB_BUILDING_BLOCKS);
	public static final RegistryObject<Item> TWILIGHT_OAK_FENCE = block(UmbreoRpgModBlocks.TWILIGHT_OAK_FENCE, CreativeModeTab.TAB_DECORATIONS);
	public static final RegistryObject<Item> TWILIGHT_OAK_FENCE_GATE = block(UmbreoRpgModBlocks.TWILIGHT_OAK_FENCE_GATE,
			CreativeModeTab.TAB_REDSTONE);
	public static final RegistryObject<Item> TWILIGHT_OAK_PRESSURE_PLATE = block(UmbreoRpgModBlocks.TWILIGHT_OAK_PRESSURE_PLATE,
			CreativeModeTab.TAB_REDSTONE);
	public static final RegistryObject<Item> TWILIGHT_OAK_BUTTON = block(UmbreoRpgModBlocks.TWILIGHT_OAK_BUTTON, CreativeModeTab.TAB_BUILDING_BLOCKS);

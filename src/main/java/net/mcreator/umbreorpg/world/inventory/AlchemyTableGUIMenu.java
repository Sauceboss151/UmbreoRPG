...
import net.mcreator.umbreorpg.procedures.AlchemyTableTickProcedureProcedure;
...
public class AlchemyTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public AlchemyTableGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(UmbreoRpgModMenus.ALCHEMY_TABLE_GUI, id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof AlchemyTableGUIMenu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			AlchemyTableTickProcedureProcedure.execute(world, entity);
		}
	}
}

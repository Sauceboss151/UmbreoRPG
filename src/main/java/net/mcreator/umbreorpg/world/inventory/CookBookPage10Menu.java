...
import net.mcreator.umbreorpg.procedures.Level9DisplayCookBookProcedureProcedure;
...
public class CookBookPage10Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CookBookPage10Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(UmbreoRpgModMenus.COOK_BOOK_PAGE_10, id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CookBookPage10Menu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			Level9DisplayCookBookProcedureProcedure.execute(entity);
		}
	}
}

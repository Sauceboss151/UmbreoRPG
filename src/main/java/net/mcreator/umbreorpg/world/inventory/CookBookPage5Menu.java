...
import net.mcreator.umbreorpg.procedures.Level4DisplayCookBookProcedureProcedure;
...
public class CookBookPage5Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CookBookPage5Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(UmbreoRpgModMenus.COOK_BOOK_PAGE_5, id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CookBookPage5Menu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			Level4DisplayCookBookProcedureProcedure.execute(entity);
		}
	}
}

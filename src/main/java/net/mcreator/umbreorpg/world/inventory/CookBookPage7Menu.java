...
import net.mcreator.umbreorpg.procedures.Level6DisplayCookBookProcedureProcedure;
...
public class CookBookPage7Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CookBookPage7Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(UmbreoRpgModMenus.COOK_BOOK_PAGE_7, id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CookBookPage7Menu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			Level6DisplayCookBookProcedureProcedure.execute(entity);
		}
	}
}

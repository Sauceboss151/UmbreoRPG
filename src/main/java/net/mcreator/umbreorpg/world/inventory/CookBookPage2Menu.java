...
import net.mcreator.umbreorpg.procedures.Level1DisplayCookBookProcedureProcedure;
...
public class CookBookPage2Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CookBookPage2Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(UmbreoRpgModMenus.COOK_BOOK_PAGE_2, id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CookBookPage2Menu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			Level1DisplayCookBookProcedureProcedure.execute(entity);
		}
	}
}

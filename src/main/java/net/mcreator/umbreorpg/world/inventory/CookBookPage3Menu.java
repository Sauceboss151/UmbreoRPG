...
import net.mcreator.umbreorpg.procedures.Level2DisplayCookBookProcedureProcedure;
...
public class CookBookPage3Menu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CookBookPage3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(UmbreoRpgModMenus.COOK_BOOK_PAGE_3, id);
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof CookBookPage3Menu) {
			Level world = entity.level;
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();

			Level2DisplayCookBookProcedureProcedure.execute(entity);
		}
	}
}

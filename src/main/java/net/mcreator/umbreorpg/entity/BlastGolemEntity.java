...
public class BlastGolemEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(UmbreoRpgModEntities.BLAST_GOLEM.get(), 5, 1, 2));
	}

	public BlastGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UmbreoRpgModEntities.BLAST_GOLEM.get(), world);
	}

	public BlastGolemEntity(EntityType<BlastGolemEntity> type, Level world) {
		super(type, world);
		xpReward = 12;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(UmbreoRpgModEntities.BLAST_GOLEM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,

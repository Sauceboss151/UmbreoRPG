...
public class MossyGolemEntity extends PathfinderMob {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(UmbreoRpgModEntities.MOSSY_GOLEM.get(), 8, 1, 3));
	}

	public MossyGolemEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(UmbreoRpgModEntities.MOSSY_GOLEM.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(UmbreoRpgModEntities.MOSSY_GOLEM.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
